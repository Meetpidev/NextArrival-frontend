...
export default function HeroSection({ user: propUser, loading: propLoading }: HeroSectionProps) {
  ...
  return (
    <>
      <section
        ref={heroRef}
        className="relative pt-8 pb-16 md:pb-20 lg:pb-24 px-0 sm:px-6 lg:px-8 z-10 overflow-visible"
      >
        {/* Background video */}
        ...
        {(!loading && user?.role === "OWNER") ? (
          <div
            ref={searchBarRef}
            className="opacity-0 mt-12 relative w-full md:w-[90%] md:max-w-5xl z-30 mx-auto px-4 md:px-0"
          >
          ...
          <div
            ref={searchBarRef}
            className="opacity-0 mt-12 relative w-full md:w-[90%] md:max-w-5xl z-30 mx-auto px-4 md:px-0 overflow-visible"
          >
